...
var ReactIScroll = function (_React$Component) {
  ...
  _createClass(ReactIScroll, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextContext) {
      return !(0, _reactFastCompare2.default)(this.props, nextProps) || !(0, _reactFastCompare2.default)(this.context, nextContext);
    }
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if ((0, _reactFastCompare2.default)(prevProps.options, this.props.options)) {
